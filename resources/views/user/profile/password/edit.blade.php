        ...
        <div class="card">
          <div class="card-body">
            <nav class="nav flex-column nav-pills nav-gap-y-1">
              ...
              <a href="{{ route('profile.password.edit') }}"  class="nav-item nav-link has-icon nav-link-faded active">
          ...
          <div class="card-body">
              ...
              <form class="form" method="POST" action="{{ route('user-password.update') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control @error('current_password', 'updatePassword') is-invalid
                  @enderror " placeholder="current password"  name="current_password">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control @error('password', 'updatePassword') is-invalid
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control @error('password_confirmation', 'updatePassword') is-invalid
