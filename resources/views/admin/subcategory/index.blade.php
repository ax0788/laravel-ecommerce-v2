...
<!--end::Dropdown-->
    ...
    {{-- Created a subcategory belongsTo Category. --}}
            ...
            <td class="d-flex">
            <a href="{{ route('admin.subcategories.edit', $item) }}" class="btn btn-info btn-md btn-clean btn-icon" title="Edit"><i class="fa fa-edit"></i></a>


                    <form  action="{{ route('admin.subcategories.destroy', $item->id) }}"  method="POST" class="ml-2">
                        @csrf
                        @method('DELETE')
