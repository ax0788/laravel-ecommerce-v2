         ...
         <tbody>
          @foreach ($district as $item)
           <tr>
            ...
            <td width="40%">
             <a href="{{ route('district.edit', $item->id) }}" class="btn btn-info" title="Edit"><i
               class="fa fa-pencil"></i></a>
             <a href="{{ route('district.delete', $item->id) }}" class="btn btn-danger" id="delete" title="Delete"><i
         ...
         <div class="form-group">
          ...
          <div class="controls">
           <select name="state_id" class="form-control">
            ...
            @foreach ($state as $dis)
             <option value="{{ $dis->id }}">{{ $dis->state_name }}
             </option>
            @endforeach
           </select>
           @error('state_id')
