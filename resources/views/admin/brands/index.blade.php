                ...
                @foreach ($brands as $item)
                 <tr>
                  ...
                  <td  class=" d-flex border-none">
                   <a href="{{ route('admin.brands.edit', $item->id) }}" class="btn btn-info btn-md btn-clean btn-icon mr-2" title="Edit"><i class="fa fa-edit"></i></a>

                    <form id="brand-destroy" action="{{ route('admin.brands.destroy', $item->id) }}"  method="POST" class="ml-3">
                        @csrf
                        @method('DELETE')
