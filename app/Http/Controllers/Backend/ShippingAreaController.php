...
class ShippingAreaController extends Controller
{
    ...
    {
        $countries = ShippingCountry::findOrFail($id);
        return view('admin.ship.country.edit', compact('countries'));
    }

    public function  CountryUpdate(Request $request, $id)
    {
        ShipDivison::findOrFail($id)->update([
            'country_name' => $request->country_name,
            'created_at' => Carbon::now(),
        ]);
    ...
    public function DistrictView()
    {
        ...
        return view('backend.ship.state.view_state', compact('country', 'state', 'district'));
    }
